...
/** Même action sur plusieurs tâches : complete, uncomplete, delete, category, priority. */
export const bulk = (ids, action, value) =>
  request('tasks/bulk', { method: 'POST', body: JSON.stringify({ ids, action, value }) });
